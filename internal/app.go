...
import (
	...
	"github.com/apalyukha/youtube-search-service/internal/config"
	"github.com/apalyukha/youtube-search-service/internal/events"
	ys "github.com/apalyukha/youtube-search-service/internal/youtube"
	"github.com/apalyukha/youtube-search-service/pkg/client/mq/rabbitmq"
	"github.com/apalyukha/youtube-search-service/pkg/client/youtube"
	"github.com/apalyukha/youtube-search-service/pkg/logging"
	"github.com/apalyukha/youtube-search-service/pkg/shutdown"
...
func NewApp(logger *logging.Logger, cfg *config.Config) (App, error) {
	...
	yts := ys.NewService(ytClient, logger)
...
func (a *app) startConsume() {
	...
	ytService := ys.NewService(ytClient, a.logger)
